...
internal class Llvm(val context: Context, val llvmModule: LLVMModuleRef) {
    ...
    val updateMemberRefFunction = importModelSpecificRtFunction("UpdateMemberRef")
    val updateGlobalRefFunction = importModelSpecificRtFunction("UpdateGlobalRef")
    ...
    val leaveFrameAndReturnRefFunction = importModelSpecificRtFunction("LeaveFrameAndReturnRef")
