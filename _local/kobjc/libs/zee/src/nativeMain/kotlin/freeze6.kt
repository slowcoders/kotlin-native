...
fun testFreeze6() {
    ensureWeakRefNotLeaks1();
    ensureWeakRefNotLeaks2();

    ensureNeverFrozenNoFreezeChild();
    ensureNeverFrozenFailsTarget();
    
    ensureFreezableHandlesCycles1();
    ensureFreezableHandlesCycles2();
    ensureFreezableHandlesCycles3();
}
