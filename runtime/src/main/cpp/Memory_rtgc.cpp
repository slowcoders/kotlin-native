...
const ObjHeader* RTGC_LeaveFrameAndReturnRef(ObjHeader** start, int param_count, ObjHeader** resultSlot, const ObjHeader* returnRef) {
  ...
  MEMORY_LOG("RTGC_LeaveFrameAndReturnRef %p: %d parameters %d locals. returns %p(%p:%p) \n", start, parameters, count, returnRef, resultSlot, *resultSlot);
...
const ObjHeader* LeaveFrameAndReturnRefStrict(ObjHeader** start, int param_count, ObjHeader** resultSlot, const ObjHeader* returnRef) {
  return RTGC_LeaveFrameAndReturnRef<true>(start, param_count, resultSlot, returnRef);
}
const ObjHeader* LeaveFrameAndReturnRefRelaxed(ObjHeader** start, int param_count, ObjHeader** resultSlot, const ObjHeader* returnRef) {
  return RTGC_LeaveFrameAndReturnRef<false>(start, param_count, resultSlot, returnRef);
}
