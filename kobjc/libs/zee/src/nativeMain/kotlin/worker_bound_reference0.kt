...
testGlobal()
// for Strict mode Only testGlobalDenyAccessOnWorker()
...
testGlobalGetWorker()
testLocal()
// for Strict mode Only  testLocalDenyAccessOnWorker()
testLocalAccessOnWorkerFrozenInitially()
testLocalAccessOnWorkerFrozenBeforePassing()
testLocalAccessOnWorkerFrozenBeforeAccess()
// for Strict mode Only  testLocalDenyAccessOnMainThread()
testLocalModification()
testLocalGetWorker()
testLocalForeignGetWorker()
testCollect()
testCollectInWorker()
testDoNotCollectInWorker()
doesNotCollectCyclicGarbage()
doesNotCollectCrossThreadCyclicGarbage()
doesNotCollectCyclicGarbageWithAtomics()
collectCyclicGarbageWithAtomics()
doesNotCollectCrossThreadCyclicGarbageWithAtomics()
collectCrossThreadCyclicGarbageWithAtomics()
// for Strict mode Only  concurrentAccess()
// for Strict mode Only  testExceptionMessage()
}
